...
#specify which columns names correspond to (for template)
...
#specify the levels in the files to be pcoded
level_tag = ['L1', 'L2' ]
...
reject_below_score= {'L1':0.55, 'L2':0.55}
...
#input names
dict_filename_to_pcode= {'file1'  : './Glenda-Hagupit---Dec-1-12-2014---TAB-C---DAMAGED-HOUSES.csv',
                         'file2'    : './Nona-Melor---Dec-10-17-2015---Tab-I---Damaged-Houses.csv',
}

#output names
dict_pcoded_sav_name={'file1'  : './file1_pcoded.csv',
                      'file2'    : './file2_pcoded.csv',
}

#name columns in input file with corresponding admin level
dict_col_names_to_pcode={'file1'  :  {'Province': 'L1_name', 
...
for file_type in list_files :
    if if_to_pcode[file_type]:
        ...
        pcode_file(filename_template ,  dict_raw_template, dict_filename_to_pcode[file_type] , dict_pcoded_sav_name[file_type],  dict_col_names_to_pcode[file_type] , ask_below_score , reject_below_score, level_tag )
